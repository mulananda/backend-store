                            ...
                            <table class="table">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                    ...
                                    <td>
                                        {{-- agar bisa mengedit status transaksi di halaman index --}}
                                        @if($item->transaction_status == 'PENDING')
                                            {{-- <a href="{{ route('transactions.status', $item->id) }}?status=SUCCESS" class="btn btn-success btn-sm">
                                                <i class="fa fa-check"></i>
                                            </a>
                                            <a href="{{ route('transactions.warning', $item->id) }}?status=FAILED" class="btn btn-success btn-sm">
                                                <i class="fa fa-times"></i>
                                            </a> --}}
                                        @endif
                                        {{--end  agar bisa mengedit status transaksi di halaman index --}}
